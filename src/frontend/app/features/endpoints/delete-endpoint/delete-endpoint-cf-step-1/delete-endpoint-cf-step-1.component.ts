...
@Component({
  selector: 'app-delete-endpoint-cf-step-1',
  templateUrl: './delete-endpoint-cf-step-1.component.html',
  styleUrls: ['./delete-endpoint-cf-step-1.component.scss']
})
export class DeleteEndpointCfStep1Component implements IStepperStep, AfterContentInit {
